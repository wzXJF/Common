    ...
    if (searchText.length>0&&![ChineseInclude isIncludeChineseInString:searchText]) {
        for (int i=0; i<originalArray.count; i++) {
            ...
            if ([ChineseInclude isIncludeChineseInString:tempString]) {
                ...
                /*
                NSString *tempPinYinStr = [PinYinForObjc chineseConvertToPinYin:tempString];// chineseConvertToPinYin
                ...
                NSString *tempPinYinHeadStr = [PinYinForObjc chineseConvertToPinYinHead:tempString];// chineseConvertToPinYinHead
